    ...
    "views": [
        {
            ...
            "cards": [
                ...
                },
                {
                    ...
                    "title": "🚨 传感器(新) / 环境",
                    "entities": [
                        "input_boolean.window_sensor",
                        "input_boolean.motion_sensor",
                        "input_boolean.door_sensor",
                        "sensor.yan_wu_chuan_gan_qi",
                        "sensor.co2_chuan_gan_qi",
                        "sensor.chuang_hu_kai_du",
                        "input_number.window_open_percent",
                        "input_number.smoke_level",
                        "input_number.co2_level",
                    ],
                },
                {
                    "type": "entities",
                ...
                {
                    "type": "entities",
                    "title": "⚙️ 自动化调试（AI Chat → Automations → 🔧）",
                    "entities": [
                        {"entity": "sensor.llm_last_response", "name": "最近执行结果"},
                    ],
                },
            ],
        }
