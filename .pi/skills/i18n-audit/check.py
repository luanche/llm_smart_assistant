...
ALLOWED_HARDCODED = {
    ...
    # Mobile UX v4 (v1.8.x): advanced options fold, type switch, autocomplete,
    # form toggles, unified card footer, debug copy + JSON highlight
    "AdvBody", "AdvToggle", "addAdvBody", "addAdvToggle", "editAdvBody", "editAdvToggle",
    "aria-checked", "false", "true", "debug", "device",
    "jv-key", "jv-string", "jv-number", "jv-bool", "jv-null",
    "HH:MM", "HH:MM:SS", "setRowType", "onEntityInput", "pickEntity", "hideEntityList",
    "toggleAdv", "copyRawLog", "syntaxHighlight", "ensureEntityIndex",
    "ent-ac-item", "ent-ac-list", "ent-autocomplete", "trig-row-head",
    "trig-type-switch", "trig-time-field", "trig-device-fields", "trig-index",
    "form-toggle", "oneshot-row", "os-label", "os-sub", "adv-toggle-btn",
    "adv-body", "adv-caret", "debug-header", "copy-raw-btn",
    "ac-neutral", "ac-debug", "ac-delete", "auto-card-footer",
    "data-tt", "data-idx", "dataset.type", "lastResponseRaw", "show", "hide",
    "textarea", "textContent", "removeChild", "appendChild", "writeText",
    "clipboard", "execCommand", "select", "preventDefault", "closest",
    "querySelector", "querySelectorAll", "parentElement", "classList",
    "toggle", "contains", "remove", "add", "on", "checked", "role",
    "switch", "autocomplete", "focus", "value", "style", "dataset",
    "text", "startswith", "includes", "slice", "map", "join", "replace",
    "regex", "json", "raw", "copy", "paste", "modal", "click", "input",
    "change", "blur", "focus", "pointerdown", "pointerup", "touchstart",
    "touchend", "getElementById", "createElement", "innerHTML", "onclick",
    "oninput", "onblur", "onfocus", "onmousedown", "data-eid", "eid", "ename",
    "on", "off", "min-width", "flex-shrink", "flex-end", "space-between",
    "center", "uppercase", "monospace", "sans-serif", "pointer", "block",
    "static", "relative", "absolute", "sticky", "auto", "nowrap", "ellipsis",
    # Schedule-aware time triggers (v1.8.x): schedule values + chips/classes
    "once", "daily", "weekly", "monthly", "md-chip", "span", "md-x",
    "schedOnce", "schedDaily", "schedWeekly", "schedMonthly", "everyDay",
    "everyWeek", "everyMonth", "daySuffix", "monthDayHint", "WEEKDAY_NAMES",
    "syncSchedDisplay", "onSchedTypeChange", "toggleWdChip", "addMonthDay",
    "sched-type-select", "sched-time-input", "sched-datetime-input",
    "sched-weekdays", "sched-monthdays-wrap", "sched-top-row", "sched-hint",
    "wd-chip", "md-input", "md-add-btn", "md-chips", "trig-sched",
    "sched-time-wrap", "sched-datetime-wrap", "data-w", "data-d", "number",
    "datetime-local", "substring", "parseInt", "dataset.d", "dataset.w",
    "acPick", "ac-pick", "color-scheme", "light dark", "backdrop-filter",
    "-webkit-backdrop-filter", "shadow-lg", "border-hover",
    "LogicHint", "LogicInput", "updateLogicHint",
